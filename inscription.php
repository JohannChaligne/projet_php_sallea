    ...
    isset($_POST['civilite'])) {
        ...
        if(empty($msg)) {
            ...
            if($mail_dispo->rowCount() > 0){
                ...
                $message_mail .= "<p>Merci d\'avance de cliquer sur le lien ci-dessous pour vérifier votre email : <a href='http://localhost/php/projet_back_end/confirm.php?id_membre=$user_id&token=$token'>cliquez ici</a>.</p>";
                ...
                $msg .= '<div class="alert alert-success"> Un mail de confirmation vous a été envoyé pour valider votre compte.</div>';
